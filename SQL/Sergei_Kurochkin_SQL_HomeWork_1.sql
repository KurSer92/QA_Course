...
--9. Вывести пользователей которые были созданы 2021-03-26 000000
...
--14. Вывести пользователей которые были созданы 2021-07-12 000000 и имеют пароль 1m313
select name, password, created_on from students where created_on = '2021-07-12 000000' and password = '1m313' 

--15. Вывести пользователей которые были созданы 2021-07-12 000000 и у которых в имени есть слово Andrey
select name, created_on from students where created_on = '2021-07-12 000000' and name like '%Andrey%'

--16. Вывести пользователей которые были созданы 2021-07-12 000000 и у которых в имени есть цифра 8
...
--27. Вывести пользователей где created_on равен 2020-10-03 000000, 2021-05-19 000000, 2021-03-26 000000
